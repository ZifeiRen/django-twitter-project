...
class NewsFeedServiceTests(TestCase):
    ...
    def setUp(self):
        ...
        self.dongxie = self.create_user('dpngxie')
    ...
    def test_get_user_newsfeeds(self):
        ...
        # cache miss
        newsfeeds = NewsFeedService.get_cache_newsfeeds(self.linghu.id)
    ...
    def test_create_new_newsfeed_before_get_cached_newsfeeds(self):
        ...
        feeds = NewsFeedService.get_cache_newsfeeds(self.linghu.id)
